...
// or have a more sophisticated system for managing SVGs.
...
const icons: Record<string, React.ReactElement> = {
  ...
  facebook: (
    <svg fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 2.04c-5.5 0-9.96 4.46-9.96 9.96s4.46 9.96 9.96 9.96c5.5 0 9.96-4.46 9.96-9.96S17.5 2.04 12 2.04zm3.33 9.24h-2.3v7.32h-3.23V11.28H8.53V8.65h1.27V6.93c0-1.25.77-1.93 1.88-1.93h1.6v2.58h-.96c-.6 0-.72.29-.72.7v1.37h1.68l-.22 2.59z" />
    </svg>
  ),
  link: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  tools: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-4.243-4.243l3.275-3.275a4.5 4.5 0 00-6.336 4.486c.046.58.028 1.193-.14 1.743m-2.132 2.132L6.57 21.07l-5.5-5.5 5.108-5.108m6.838 6.838a.75.75 0 001.06-1.06L9.422 8.568l-1.06 1.06 5.656 5.656z" />
    </svg>
  ),
  info: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
